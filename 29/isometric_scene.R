...
ggplot() +
  ...
  geom_path(data = sidewalk_transpose[["sidewalk_main"]], aes(x = x, y = y, group = id), color = "black", size = 0.1) +
  geom_segment(data = sidewalk_transpose[["sidewalk_lines"]], aes(x = x, y = y, xend = xend, yend = yend), size = 0.05) +
