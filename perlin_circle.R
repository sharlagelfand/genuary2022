...
generate_blobby_flower_data <- function(cx = 1, cy = 1, r = 1, petal_color = "pink", pistil_color = "yellow") {
  dplyr::tribble(
...
generate_spiky_flower_data <- function(cx = 1, cy = 1, r = 1, petal_color = "pink", pistil_color = "yellow") {
  dplyr::tribble(
    ~cx, ~cy, ~n, ~noise_max, ~octaves, ~r_min, ~r_max, ~color, ~section,
